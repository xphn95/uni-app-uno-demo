...
const preflights = [
  {
    ...
    getCSS(ctx) {
      if (ctx.theme.preflightBase)
        return `page,::before,::after{${core.entriesToCss(Object.entries(ctx.theme.preflightBase))}}`;
    }
  }
];
...
const presetApplet = (options = {}) => {
  ...
  return {
    ...
    options,
    preflights: enable ? preflights : presetMini.preflights,
    postprocess: [
      (util) => {
