import { a as animations, b as backgroundStyles, d as displays, c as borders, e as contentVisibility, f as contents, g as fonts, t as tabSizes, h as textIndents, i as textOverflows, j as textDecorations, k as textStrokes, l as textShadows, m as textTransforms, n as textAligns, o as fontStyles, p as fontSmoothings, q as boxShadows, r as rings, s as positions, u as cursors, v as appearances, w as pointerEvents, x as resizes, y as verticalAligns, z as userSelects, A as whitespaces, B as breaks, C as overflows, D as outline, E as appearance, F as orders, G as justifies, H as alignments, I as placements, J as insets, K as floats, L as zIndexes, M as boxSizing, N as transitions, O as transforms, P as willChange, Q as backgroundBlendModes, R as hyphens, S as isolations, T as mixBlendModes, U as objectPositions, V as screenReadersAccess, W as writingModes, X as writingOrientations } from './unocss-preset-weapp.7771df0e.mjs';
import { h as handler, d as colorResolver, n as numberWithUnitRE, r as resolveVerticalBreakpoints, l as resolveBreakpoints, o as directionSize } from './unocss-preset-weapp.3720715e.mjs';
import '@unocss/core';
...
const svgUtilities = [
  ...
  [
    ...
    ([, s], { theme }) => {
      ...
      return { "stroke-width": theme.lineWidth?.[s] ?? handler.bracket.cssvar.fraction.px.number(s) };
    },
...
export { grids as a, bgColors as b, aspectRatio as c, svgUtilities as d, cssVariables as e, flex as f, gaps as g, cssProperty as h, safeArea as i, margins as m, opacity as o, paddings as p, questionMark as q, rules as r, sizes as s, textColors as t };
