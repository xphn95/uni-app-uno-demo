...
const decoration = require('./unocss-preset-weapp.41ef2805.cjs');
...
function getSizeValue(minmax, hw, theme, prop) {
  prop = utils.restoreSelector(prop, theme?.transformRules);
...
const svgUtilities = [
  ...
  [
    ...
    ([, s], { theme }) => {
      ...
      return { "stroke-width": theme.lineWidth?.[s] ?? colors.handler.bracket.cssvar.fraction.px.number(s) };
    },
...
const rules = [
  ...
  safeArea,
  questionMark,
  decoration.backgroundBlendModes,
  decoration.hyphens,
  decoration.isolations,
  decoration.mixBlendModes,
  decoration.objectPositions,
  decoration.screenReadersAccess,
  decoration.textTransforms,
  decoration.writingModes,
  decoration.writingOrientations
].flat(1);
