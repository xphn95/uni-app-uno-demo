...
function parseColor$1(body, theme) {
  const split = restoreSelector(body, theme.transformRules).split(/(?:\/|\_|:)/);
  let main, opacity;
  if (split[0] === "[color") {
...
export { CONTROL_MINI_NO_NEGATIVE as C, positionMap as a, colorOpacityToString as b, colorToString as c, colorResolver as d, directionMap as e, hasParseableColor as f, globalKeywords as g, handler as h, cornerMap as i, colorableShadows as j, insetMap as k, resolveBreakpoints as l, makeGlobalStaticRules as m, numberWithUnitRE as n, directionSize as o, parseColor$1 as p, getComponent as q, resolveVerticalBreakpoints as r, hex2rgba as s, parseCssColor as t, h as u, valueHandlers as v, getComponents as w, xyzMap as x };
